#!/bin/bash
# Set up a popschain service to join the popschain-1 chain.
...
echo "Description=popschain service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the popschain service:"
